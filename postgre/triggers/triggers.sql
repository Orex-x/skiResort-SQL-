...
(
    ID_Trigger_History SERIAL      not null
        constraint PK_Trigger_History primary key,
...
CREATE TRIGGER trigger_Outfit
    AFTER INSERT OR UPDATE OR DELETE
    ON Outfit
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_outfit();
...
CREATE TRIGGER trigger_Rental_Outfit
    AFTER INSERT OR UPDATE OR DELETE
    ON Rental_Outfit
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_rental_outfit();
...
CREATE TRIGGER trigger_Status_Card
    AFTER INSERT OR UPDATE OR DELETE
    ON Status_Card
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_status_card();
...
CREATE TRIGGER trigger_Bonus_Card
    AFTER INSERT OR UPDATE OR DELETE
    ON Bonus_Card
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_bonus_card();
...
CREATE TRIGGER trigger_Position
    AFTER INSERT OR UPDATE OR DELETE
    ON Position
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_position();
...
CREATE TRIGGER trigger_Employee
    ...
    ON Employee
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_employee();
...
CREATE TRIGGER trigger_Cableway
    AFTER INSERT OR UPDATE OR DELETE
    ON Cableway
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_cableway();
...
CREATE TRIGGER trigger_Track
    AFTER INSERT OR UPDATE OR DELETE
    ON Track
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_track();
...
CREATE TRIGGER trigger_Status_Card_Track
    AFTER INSERT OR UPDATE OR DELETE
    ON Status_Card_Track
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_status_card_track();
...
CREATE TRIGGER trigger_Client
    ...
    ON Client
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_client();
...
CREATE TRIGGER trigger_Receipt
    AFTER INSERT OR UPDATE OR DELETE
    ON Receipt
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_receipt();
...
CREATE TRIGGER trigger_Rental_Outfit_Client
    AFTER INSERT OR UPDATE OR DELETE
    ON Rental_Outfit_Client
    FOR EACH ROW
EXECUTE PROCEDURE add_to_log_rental_outfit_client();
