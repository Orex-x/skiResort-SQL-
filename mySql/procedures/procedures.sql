...
begin
    ...
    from rental_outfit
    where price = p_price
      and date_issue = p_date_issue
      and return_date = p_return_date
...
use test;
DELIMITER //
create procedure rental_outfit_update(p_id_rental_outfit int, p_price int, p_date_issue datetime,
                                      p_return_date datetime, p_outfit_id int)
...
begin
    ...
    where balance = p_balance
      and tariff = p_tariff
      and status_card_id = p_status_card_id;
...
begin
    ...
    from position
    where title = p_title
      and post_price = p_post_price
      and description = p_description
      and responsibilities = p_responsibilities;
...
use test;
DELIMITER //
create procedure employee_insert(p_first_name varchar(30), p_second_name varchar(30), p_middle_name varchar(30),
                                 p_phone_number varchar(19),
...
use test;
DELIMITER //
create procedure employee_update(p_id_employee int, p_first_name varchar(30), p_second_name varchar(30),
...
begin
    ...
    select count(*)
    into have_record_receipt
    from receipt
    where employee_id = p_id_employee;
    select count(*)
    into have_record_track
    from track
    where employee_id = p_id_employee;
    select count(*)
    into have_record_rental_outfit_client
    from rental_outfit_client
    where employee_id = p_id_employee;
...
begin
    ...
    into have_record
    from track
    where complexity = p_complexity
      and title = p_title
      and employee_id = p_employee_id
      and cableway_id = p_cableway_id;
...
use test;
DELIMITER //
create procedure track_update(p_id_track int, p_complexity int, p_title varchar(50), p_employee_id int,
                              p_cableway_id int)
...
begin
    ...
    into have_record
    from status_card_track
    where track_permission = p_track_permission
...
use test;
DELIMITER //
create procedure status_card_track_update(p_id_status_card_track int, p_track_permission boolean, p_track_id int,
...
use test;
DELIMITER //
create procedure client_insert(p_first_name varchar(30), p_second_name varchar(30), p_middle_name varchar(30),
                               p_phone_number varchar(19),
...
begin
    ...
    where first_name = p_first_name
      ...
      and email = p_email
      and age = p_age
      and numberdl = p_numberdl
      and bonus_card_id = p_bonus_card_id;
...
use test;
DELIMITER //
create procedure client_update(p_id_client int, p_first_name varchar(30), p_second_name varchar(30),
                               p_middle_name varchar(30), p_phone_number varchar(19),
                               p_email varchar(300), p_age int, p_numberdl varchar(11), p_bonus_card_id int)
...
begin
    ...
    into have_record
    from receipt
    where date_of_creation = p_date_of_creation
      and employee_id = p_employee_id
      and rental_outfit_client_id = p_rental_outfit_client_id;
...
use test;
DELIMITER //
create procedure receipt_update(p_id_receipt int, p_date_of_creation date, p_employee_id int,
...
begin
    ...
    where employee_id = p_employee_id
      ...
      and rental_outfit_id = p_rental_outfit_id;
...
use test;
DELIMITER //
create procedure rental_outfit_client_update(p_id_rental_outfit_client int, p_employee_id int, p_client_id int,
                                             p_rental_outfit_id int)
