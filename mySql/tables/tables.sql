...
(
    ...
    phone_number varchar(19) not null check (phone_number like '\+7\([0-9][0-9][0-9]\)[0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]'),
...
(
    ...
    email varchar(300) null default '@.' check (email like '%@%.%'),
    age int not null default (0) check (age >= 0),
    numberdl varchar(11) null default '-' check (phone_number like '[0-9][0-9][0-9][0-9]-[0-9][0-9][0-9][0-9][0-9][0-9]'),
